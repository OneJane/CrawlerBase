...
SPIDER_MODULES = ['dishonest.dishonest.spiders']
NEWSPIDER_MODULE = 'dishonest.dishonest.spiders'
...
# Forbidden by robots.txt: 解决方案: 注释或设置为False
...
ITEM_PIPELINES = {
   'dishonest.dishonest.pipelines.DishonestPipeline': 300,
}
