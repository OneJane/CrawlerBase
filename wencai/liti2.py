...
def at(d):
    return (d["竞价量"] * d["竞价换手率"] / d["昨日成交量"]) > 0.01 and d['竞价涨幅']<9
...
if __name__ == '__main__':
    ...
    ques_list = [
        "2022年3月1日_上市天数，2022年3月1日竞价实际换手率大于1%，2022年3月1日竞价涨幅，2022年2月28日成交量，2022年3月1日竞价换手率，2022年3月1日竞价量比，主板，2022年3月1日竞价额，2022年3月1日涨跌幅排序，非st，2022年3月1日竞价量",
    ...
    for i in final_res_list:
        ...
        at_list.sort(key=lambda x: (x['竞价额'] * x["竞价量比"] * x["昨日成交量"] / x["竞价量"]/x["竞价换手率"]), reverse=True) # 103 74
        # a_list = []
        # for a in at_list:
